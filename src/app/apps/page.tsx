...
export default function Apps() {
  return (
    <div className="p-4 lg:p-6">
      <h1 className="mb-6 font-mono text-lg font-bold tracking-widest text-ink">APLICATIVOS</h1>
      ...
      <section>
        <h2 className="mb-2 font-mono text-[11px] font-bold tracking-widest text-inkDim">
          AINDA NÃO PORTADOS
        </h2>
